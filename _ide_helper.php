...
namespace Nwidart\Modules\Facades {
     ...
     */        class Module {
         ...
         *
         * @param string $path
         * @return \LarabizCMS\Core\Modules\FileRepository
         * @static
         */        public static function addLocation($path)
        {            //Method inherited from \Nwidart\Modules\FileRepository
                        /** @var \LarabizCMS\Core\Modules\FileRepository $instance */
         ...
         *
         * @return \LarabizCMS\Core\Modules\Support\Collection
         * @static
         ...
         *
         * @return string
         * @throws \LarabizCMS\Core\Modules\Exceptions\ModuleNotFoundException
         * @static
         ...
         */        public static function macro($name, $macro)
        {            //Method inherited from \Nwidart\Modules\FileRepository
                        \LarabizCMS\Core\Modules\FileRepository::macro($name, $macro);
        }
                    /**
         * Mix another object into the class.
         *
         ...
         */        public static function mixin($mixin, $replace = true)
        {            //Method inherited from \Nwidart\Modules\FileRepository
                        \LarabizCMS\Core\Modules\FileRepository::mixin($mixin, $replace);
        }
                    /**
         * Checks if macro is registered.
         *
         ...
         */        public static function hasMacro($name)
        {            //Method inherited from \Nwidart\Modules\FileRepository
                        return \LarabizCMS\Core\Modules\FileRepository::hasMacro($name);
        }
                    /**
         * Flush the existing macros.
         *
         ...
         */        public static function flushMacros()
        {            //Method inherited from \Nwidart\Modules\FileRepository
                        \LarabizCMS\Core\Modules\FileRepository::flushMacros();
        }
            }
    }
...
namespace Illuminate\Database\Query {
     ...
     */        class Builder {
         ...
         *
         *
         * @see \LarabizCMS\ForDev\Providers\ForDevServiceProvider::macroBuilderForDev()
         * @static
...
namespace  {
             ...
             */            public static function ddRawSql()
            {
                                return \Illuminate\Database\Eloquent\Builder::ddRawSql();
            }
                            /**
